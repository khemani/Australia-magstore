...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$this->data['text_journals'] = $this->language->get('text_journals');
		...
		$this->data['entry_periodicity'] = $this->language->get('entry_periodicity');
		$this->data['entry_issues_per_year'] = $this->language->get('entry_issues_per_year');
		
		$this->data['startdateod'] =date('y-m-d');
		$this->data['enddateod'] = date('y+5-m-d');
		
		
		
		$this->data['entry_issn_print'] = $this->language->get('entry_issn_print');
		$this->data['entry_iisn_online'] = $this->language->get('entry_iisn_online');
		$this->data['entry_marketed_by'] = $this->language->get('entry_marketed_by');
		$this->data['entry_supplied_by'] = $this->language->get('entry_supplied_by');
		$this->data['entry_periodicity'] = $this->language->get('entry_periodicity');
		$this->data['entery_mlanguage'] = $this->language->get('entery_mlanguage');
		$this->data['entery_estimated_delivery'] = $this->language->get('entery_estimated_delivery');
		$this->data['entery_remarks'] = $this->language->get('entery_remarks');
		$this->data['entery_note'] = $this->language->get('entery_note');
		...
		if (isset($this->request->post['mpn'])) {
			...
			if (isset($this->request->post['periodicity'])) {
			$this->data['periodicity'] = $this->request->post['periodicity'];
		} elseif (!empty($product_info)) {
			...
			if (isset($this->request->post['mlanguage'])) {
			$this->data['mlanguage'] = $this->request->post['mlanguage'];
		} elseif (!empty($product_info)) {
			...
			if (isset($this->request->post['issues_per_year'])) {
			$this->data['issues_per_year'] = $this->request->post['issues_per_year'];
		} elseif (!empty($product_info)) {
			$this->data['issues_per_year'] = $product_info['issues_per_year'];
		} else {
			$this->data['issues_per_year'] = '';
		}
		
			if (isset($this->request->post['issn_print'])) {
			$this->data['issn_print'] = $this->request->post['issn_print'];
		} elseif (!empty($product_info)) {
			$this->data['issn_print'] = $product_info['issn_print'];
		} else {
			$this->data['issn_print'] = '';
		}
			if (isset($this->request->post['iisn_online'])) {
			$this->data['iisn_online'] = $this->request->post['iisn_online'];
		} elseif (!empty($product_info)) {
			$this->data['iisn_online'] = $product_info['iisn_online'];
		} else {
			$this->data['iisn_online'] = '';
		}
			if (isset($this->request->post['marketed_by'])) {
			$this->data['marketed_by'] = $this->request->post['marketed_by'];
		} elseif (!empty($product_info)) {
			$this->data['marketed_by'] = $product_info['marketed_by'];
		} else {
			$this->data['marketed_by'] = '';
		}
			if (isset($this->request->post['supplied_by'])) {
			$this->data['supplied_by'] = $this->request->post['supplied_by'];
		} elseif (!empty($product_info)) {
			$this->data['supplied_by'] = $product_info['supplied_by'];
		} else {
			$this->data['supplied_by'] = '';
		}
			if (isset($this->request->post['estimated_delivery'])) {
			$this->data['estimated_delivery'] = $this->request->post['estimated_delivery'];
		} elseif (!empty($product_info)) {
			$this->data['estimated_delivery'] = $product_info['estimated_delivery'];
		} else {
			$this->data['estimated_delivery'] = '';
		}
			...
			$this->data['origin'] = $this->request->post['origin'];
		} elseif (!empty($product_info)) {
		...
		foreach ($product_options as $product_option) {
			if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') {
				...
				foreach ($product_option['product_option_value'] as $product_option_value) {
					$product_option_value_data[] = array(
'pods' => isset($product_option_value['pod']) ? $product_option_value['pod'] : array(),
