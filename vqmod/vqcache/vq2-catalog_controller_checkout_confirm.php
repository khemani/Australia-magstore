...
if((float)$option['price']) {
					...
					$option_data[] = array(
'price' => (float)$option['price'] ? $option['price_prefix'] . $this->currency->format($this->tax->calculate($option['price'], $product['tax_class_id'], $this->config->get('config_tax'))) : false,
				'special' => (isset($option['special']) && $option['special'] !== false) ? $option['special_prefix'] . $this->currency->format($this->tax->calculate($option['special'], $product['tax_class_id'], $this->config->get('config_tax'))) : false,
