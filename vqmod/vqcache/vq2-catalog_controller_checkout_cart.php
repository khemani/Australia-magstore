...
$tax_class_id = isset($product['tax_class_id']) ? $product['tax_class_id'] : $result['tax_class_id'];
					$option_data[] = array(
'price' => (float)$option['price'] ? $option['price_prefix'] . $this->currency->format($this->tax->calculate($option['price'], $tax_class_id, $this->config->get('config_tax'))) : false,
				'special' => (isset($option['special']) && $option['special'] !== false) ? $option['special_prefix'] . $this->currency->format($this->tax->calculate($option['special'], $tax_class_id, $this->config->get('config_tax'))) : false,
						'name'  => $option['name'],
