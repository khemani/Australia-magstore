...
$dbdriver = "Database driver";	# Database driver
$dbhost = "Database host name";	# Database host name
$dbname = "Database name"; # Database name
$dbuser = "Database username"; # Database username
$dbpass = "Database password"; # Database password
$prefix = "Database prefix"; # Database prefix tables
