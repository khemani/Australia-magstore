          ...
          <table class="form">
            ...
            <tr>
              ...
              <select name="periodicity" id="periodicity">
                <option value="" selected="selected">Select Periodicity</option>
                  ...
                  <?php } ?>
                   ...
                   <?php if (  $periodicity == 'Weekly' ) { ?>
                  <option value="Weekly" selected="selected">Weekly</option>
                  <?php } else { ?>
				  <option value="Weekly" >Weekly</option>
                  <?php } ?>
                  
                   <?php if (  $periodicity == '15 Days' ) { ?>
                  <option value="15 Days" selected="selected">15 Days</option>
                  <?php } else { ?>
				  <option value="15 Days" >15 Days</option>
                  <?php } ?>
                  
                   <?php if (  $periodicity == 'Monthly' ) { ?>
                  <option value="Monthly" selected="Monthly">Daily</option>
                  <?php } else { ?>
				  <option value="Monthly" >Monthly</option>
                  <?php } ?>
                  
                    <?php if (  $periodicity == 'Yearly' ) { ?>
                  <option value="Yearly" selected="Yearly">Yearly</option>
                  <?php } else { ?>
