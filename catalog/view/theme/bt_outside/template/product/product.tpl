        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            ...
            <div class="product-info" style="margin-bottom:0px;">
                <div class="row">
                    ...
                    <?php } ?>
                    <div id="product_content" class="col-md-15 col-xs-24 not-animated" data-animate="fadeInUp" data-delay="300">
                        <h1 class="s8_head_title"><?php echo $heading_title; ?></h1>
                        <div class="review">
                        ...
                        <div class="description">
                            ...
                            <?php if ($description) { ?>
                            <?php echo '<div class="product_limit_desc">'.$this->limit_words($description,46,'<a href="'.$_SERVER{'REQUEST_URI'}.'#cart_check"> ... Read more >></a>').'</div>'; ?><br />
                            <?php } ?>
                            <?php if ($periodicity) { ?>
                    ...
                    <div class="list_carousel responsive" >
                        <ul id="product_related" class="box-product"><?php foreach ($products as $product) { ?><li>
                                <div class="relt_product">
                                    ...
                                    <div class="cart"><a onclick="boss_addToCart('<?php echo $product['product_id']; ?>');" class="btn btn-cart"><?php echo $button_cart; ?></a>
