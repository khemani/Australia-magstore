                ...
                <div class="row">
                    ...
                    <div class="col-md-15 col-xs-24 not-animated" data-animate="fadeInUp" data-delay="300">
                        ...
                        <div class="description">
                            ...
                            <?php if ($origin) { ?>
                            <span><strong><?php //echo $text_origin; ?>Origin :</strong></span><?php echo $origin; ?><br />
                            <?php } ?>
                    ...
                    <div class="list_carousel responsive" >
                        <ul id="product_related" class="box-product"><?php foreach ($products as $product) { ?><li>
                                <div class="relt_product">
                                    ...
                                    <?php /*?>	   <div class="compare"><a class="action-button" title="<?php echo $button_compare; ?>" onclick="boss_addToCompare('<?php echo  $product['product_id'];  ?>');"><i class="fa fa-plus"></i><?php echo $button_compare; ?></a></div>
