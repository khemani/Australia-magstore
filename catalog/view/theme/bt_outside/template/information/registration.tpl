...
<div class="left col-sm-12"><img style="float:left; margin-right: 74px;  width: 115px;" src="/image/data/smiley.jpg"><br /><br><br><br><br>
  <h1><?php echo $heading_title; ?></h1></div><div class="right col-sm-12"><img style="float:right; width: 160px;margin-right: 74px;  " src="/image/information/Contact_us.jpg"></div>
    ...
    <div class="content" style ="margin-bottom:2px">
      ...
      <table class="form">
       <tr>
          ...
          <td> Registration For<span class="required">*</span></td>
		...
		<tr>
          ...
          <td><select class="form-control" name="country_id">
              ...
              <option value="<?php echo $country['country_id']; ?>" selected="selected">Library</option>
               <option value="<?php echo $country['country_id']; ?>" selected="selected">Corporate</option> 
               <option value="<?php echo $country['country_id']; ?>" selected="selected">Dealer</option>
                <option value="<?php echo $country['country_id']; ?>" selected="selected">Publishers</option>
		...
		<tr>
          ...
          <td><input class="form-control" type="text" name="designation" value="<?php echo ''; ?>" />
		...
		<tr>
          ...
          <td><input class="form-control" type="text" name="department" value="<?php echo ''; ?>" />
         ...
         <tr>
          ...
          <td> Organisation <span class="required">*</span></td>
		...
		<tr>
          ...
          <td><input class="form-control" type="text" name="website" value="<?php echo '' ?>" />
...
<!--    <h2><?php echo $text_newsletter; ?></h2>
 ...
 <tr>
		...
		<tr>
          ...
          <td><textarea class="form-control" rowspan="10" cols="40" name="enquiry"></textarea></td>

        </tr>
        
        <tr>

          <td align="center"><a href=""><img src="/image/data/getquote.jpg" /></a></td>
