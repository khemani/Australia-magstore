    ...
    public function getProduct($product_id) {
        ...
        if ($query->num_rows) {
            return array(
                ...
                'isbn' => $query->row['isbn'],
                'mpn' => $query->row['mpn'],
                'periodicity' => $query->row['periodicity'],
                'mlanguage' => $query->row['mlanguage'],
                'issues_per_year' => $query->row['issues_per_year'],
                'issn_print' => $query->row['issn_print'],
                'iisn_online' => $query->row['iisn_online'],
                'marketed_by' => $query->row['marketed_by'],
                'supplied_by' => $query->row['supplied_by'],
                'estimated_delivery' => $query->row['estimated_delivery'],
                'remarks' => $query->row['remarks'],
                'note' => $query->row['note'],
