...
class ControllerModuleBossTagCloud extends Controller {
	...
	public function install() {
		...
		foreach($languages as $language){
			$array_description{$language['language_id']} = 'Tag Cloud';
		}
		$boss_tagcloud = array('boss_tagcloud_module' => array ( 
        0 => array ( 'limit' => 20, 'title' => $array_description, 'font_weight' => 'normal','layout_id' => $this->getIdLayout("category"), 'position' => 'column_left', 'min_font_size' => 9, 'max_font_size' => 25, 'status' => 1, 'sort_order' => 5),
		1 => array ( 'limit' => 20, 'title' => $array_description, 'font_weight' => 'normal','layout_id' => $this->getIdLayout("product"), 'position' => 'column_left', 'min_font_size' => 9, 'max_font_size' => 25, 'status' => 1, 'sort_order' => 5),
        2 => array ( 'limit' => 20, 'title' => $array_description, 'font_weight' => 'normal','layout_id' => $this->getIdLayout("manufacturer"), 'position' => 'column_left', 'min_font_size' => 9, 'max_font_size' => 25, 'status' => 1, 'sort_order' => 5)
		));
